...
t_VERB = r'(fait|mangeras|aboient|passe|appartient|lèvent|sont|ressemble|s\'assemble|mord|jeter|faut|battre|est|rendent|pavé|3ad|makatessfe9ch|dreb|yessbr|madir|mayterra|chetk|chebhtk|libgha|hadini|3attini|yedawi|dawa|kan|kaynbh|yahml|make|strike|is|fail|stop|bite|feeds|flock|hate|heal|catches|brings|learn|walk|run)'
t_ADJECTIVE = r"(son|petit|ton|chaussés|d'échecs|honnêteté|meilleure|chaud|plusieurs|léger|waheda|skhon|9asseh|hessan|lkeddab|bekri|macheri|many|light|hot|best|early|empty|hard|sweet|much)"
t_NOUN = r'(l\'oiseau|nid|sueur|front|pain|chiens|caravane|monde|cordonniers|envie|serpent|queue|manche|cognée|chemin|réussite|échecs|politique|mains|travail|yedd|lhdid|la3ssel|lkriss|nhell|khir|bas|rebbi|lkhoukh|lfya9|dheb|lkelb|de9a|lwad|hands|work|iron|honesty|policy|hand|birds|feather|physician|bird|worm|vessels|noise|fruit)'
t_CONJUNCTION = r'(que|pendant|maheddo|mahedek|o|kon|li|makay|while|when|that|cause)'
t_ARTICAL = r'(du|les|un|la|a|le|the|a)'
t_PRONOUN = r'(c\'est|que|tu|ceux|qui|se|qu\'il|rasso|they|you|us|thyself)'
t_ADVERB = r'(tôt|toujours|plus|mal|ne|pas|only|together)'
t_GERUND = r'(trying)'
t_CONTRUDICTION = r"(don't|ain't|ga3)"
t_PREPOSITION = r'(à|après|de|mn|m3amen|b|of|to|before)'
